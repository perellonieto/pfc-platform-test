...
\figuremacroW{utilitzant/mplabx/mplabx_u_05}{Programadors MplabX}{Els programadors apareixen de diferent color segons la compatibilitat amb \MplabX veure la taula \ref{tab:mplab_colors}}{0.6}
