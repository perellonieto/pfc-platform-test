...
class DesignerMainWindow(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent = None):
        ...
        QtCore.QObject.connect(self.pushButton_reload, QtCore.SIGNAL(_fromUtf8("clicked()")), self.reload_clicked)
    ...
    def recive_data(self):
        ...
        while self.ser.inWaiting() > INPUT_DATA_SIZE+1:
            ...
            if data[20] == chr(1):
                ...
                for i in range(i[0]):
                    self.listWidget_link.addItems(data[i])
    ...
    def toggled_monitor(self):
        ...
        if self.pushButton_monitor.isChecked():
            ...
            # send Monitor
            word = struct.pack("BBBBBBBB", ID_MONITOR,0,0,0,0,0,0,0)
