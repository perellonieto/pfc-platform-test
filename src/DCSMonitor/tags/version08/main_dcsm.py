...
class DesignerMainWindow(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent = None):
        ...
        QtCore.QObject.connect(self.pushButton_save, QtCore.SIGNAL(_fromUtf8("clicked()")), self.select_file)
    ...
    def select_file(self):
        ...
        file_one = QtGui.QFileDialog.getSaveFileName(self,QtGui.QApplication.translate("MainWindow", "Save plot in file", None, QtGui.QApplication.UnicodeUTF8))
        ...
        if file_one:
            ...
            #pp = matplotlib.backends.backend_pdf.PdfPages(file_one)
            #pp.savefig(self.mplWidget.canvas.figure)
            #pp.savefig(self.plotFigureself.mplWidget.plotFigure)
            
            #TODO: se tiene que ver porque no se guarda bien
...
#            ax.draw_artist(self.referenceLine)
#            if self.checkBox_x0.isChecked():
#                ax.draw_artist(self.x0Line)
#            if self.checkBox_U.isChecked():
#                ax.draw_artist(self.uLine)
#            if self.checkBox_x1.isChecked():
#                ax.draw_artist(self.x1Line)
#                
#            #ax.plot(x,y)
#            ax.legend("hola", loc = 'best')
#            #fig.savefig('himom.png')
#            fig.savefig(str(file_one), dpi=300)
            self.mplWidget.canvas.figure.savefig(str(file_one), dpi=300)
