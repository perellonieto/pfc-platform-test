...
class DesignerMainWindow(QtGui.QMainWindow, Ui_MainWindow):
    ...
    def __init__(self, parent = None):
        ...
        QtCore.QObject.connect(self.pushButton, QtCore.SIGNAL("clicked()"), self.update_graph)
    ...
    def select_file(self):
        ...
        file_one = QtGui.QFileDialog.getOpenFileName()
        # if a file is selected
        if file_one:
            # update the lineEdit text with the selected filename
            self.mpllineEdit.setText(file_one)
