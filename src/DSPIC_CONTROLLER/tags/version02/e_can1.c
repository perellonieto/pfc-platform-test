...
{
	ecan1Initialize();//Initialize enhanced CAN bus number 1

	ecan1WriteRxAcptMask(0x0,0x1FFFFFFF, 0,0x1);
	ecan1WriteRxAcptMask(0x2,0x1C0003FF, 0,0x1);

	ecan1WriteRxAcptFilter(0x0,ID_FROM_SENSOR,0x1,0x1,0x0);  //id=1 to buffer 1
	ecan1WriteRxAcptFilter(0x1,ID_TO_ACTUATOR,0x1,0x2,0x0);//id=2 to buffer 2
	ecan1WriteRxAcptFilter(0x2,ID_REFERENCE,0x1,0x3,0x0);//id=3 to buffer 3
	//ecan1WriteRxAcptFilter(0x3,ID_SUPERVISOR,0x1,0x4,0x0);      //ID_SUPERVISOR to buffer 4
}
