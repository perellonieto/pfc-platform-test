...
void eCAN1_config(void)
{
	...
	ecan1WriteRxAcptMask(0x0,0x1FFFFFFF, 0x0,0x1);
	//ecan1WriteRxAcptMask(0x1,0x00000000, 0x0,0x1);

	ecan1WriteRxAcptFilter(0x0,ID_PLANT,0x1,0x1,0x0);	//id=1 to buffer 0
	ecan1WriteRxAcptFilter(0x1,ID_PLANT+1,0x1,0x2,0x0);//id=2 to buffer 1
	ecan1WriteRxAcptFilter(0x2,ID_PLANT+2,0x1,0x3,0x0);//id=3 to buffer 2
